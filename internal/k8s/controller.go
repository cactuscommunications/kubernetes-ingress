...
func (lbc *LoadBalancerController) addAppProtectPolicyHandler(handlers cache.ResourceEventHandlerFuncs) {
	lbc.addAppProtectHandlers(handlers, appprotect.PolicyGVR, lbc.appProtectPolicyLister)
}
...
func (lbc *LoadBalancerController) addAppProtectLogConfHandler(handlers cache.ResourceEventHandlerFuncs) {
	lbc.addAppProtectHandlers(handlers, appprotect.LogConfGVR, lbc.appProtectLogConfLister)
}
...
func (lbc *LoadBalancerController) addAppProtectUserSigHandler(handlers cache.ResourceEventHandlerFuncs) {
	lbc.addAppProtectHandlers(handlers, appprotect.UserSigGVR, lbc.appProtectUserSigLister)
}
...
func (lbc *LoadBalancerController) addAppProtectDosPolicyHandler(handlers cache.ResourceEventHandlerFuncs) {
	lbc.addAppProtectHandlers(handlers, appprotectdos.DosPolicyGVR, lbc.appProtectDosPolicyLister)
}
...
func (lbc *LoadBalancerController) addAppProtectDosLogConfHandler(handlers cache.ResourceEventHandlerFuncs) {
	lbc.addAppProtectHandlers(handlers, appprotectdos.DosLogConfGVR, lbc.appProtectDosLogConfLister)
}

// addAppProtectHandlers creates dynamic informers for custom appprotect and appprotectdos policy resource
func (lbc *LoadBalancerController) addAppProtectHandlers(handlers cache.ResourceEventHandlerFuncs, gvr schema.GroupVersionResource, lister []cache.Store) {
	for _, dif := range lbc.dynInformerFactory {
		informer := dif.ForResource(gvr).Informer()
		informer.AddEventHandler(handlers)
		lister = append(lister, informer.GetStore())
...
func (lbc *LoadBalancerController) updateVirtualServerRoutesStatusFromEvents() error {
	var allErrs []error
	for _, vsrl := range lbc.virtualServerLister {
